         ...
         (sqlite:with-transaction db
           (mapc
            ...
            '(
              ...
              "CREATE TABLE media (physical_id INTEGER PRIMARY KEY AUTOINCREMENT, timestamp INTEGER NOT NULL, imprinted_isbn STRING NULL, condition STRING NULL, notes STRING NULL, status STRING NOT NULL, pub_id INTEGER NULL, FOREIGN KEY(pub_id) REFERENCES publication_details(pub_id))"
              ))))
       db-path))))
